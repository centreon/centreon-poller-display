 ...
 * @author Centreon
 */
class CentreonPollerDisplayCentral_AclGroupContactsRelation extends PHPUnit_Framework_TestCase
{
    protected static $db;
    ...
    public function setUp()
    {
        ...
        self::$acl = new AclGroupContactsRelation(self::$db, self::$pollerDisplay);
    ...
    public function testGenerateSql()
    {
        ...
        $expectedResult = 'DELETE FROM acl_group_contacts_relations;
TRUNCATE acl_group_contacts_relations;
INSERT INTO `acl_group_contacts_relations` (`cg_cg_id`,`acl_group_id`) VALUES (\'4\',\'1\');';
