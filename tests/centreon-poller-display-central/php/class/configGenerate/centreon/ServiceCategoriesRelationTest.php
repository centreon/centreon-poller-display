 ...
 * @author Centreon
 */
class CentreonPollerDisplayCentral_ServiceCategoriesRelation extends PHPUnit_Framework_TestCase
{
    protected static $db;
    ...
    public function setUp()
    {
        ...
        self::$service = new ServiceCategoriesRelation(self::$db, self::$pollerDisplay);
