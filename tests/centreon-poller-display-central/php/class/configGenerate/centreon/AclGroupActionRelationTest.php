 ...
 * @author Centreon
 */
class CentreonPollerDisplayCentral_AclGroupActionRelation extends PHPUnit_Framework_TestCase
{
    protected static $db;
    ...
    public function setUp()
    {
        ...
        self::$acl = new AclGroupActionsRelation(self::$db, self::$pollerDisplay);
